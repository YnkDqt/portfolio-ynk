...
// Parse [texte](url) en liens cliquables
function renderContent(text) {
  return text.split(/(\[[^\]]+\]\([^)]+\))/g).map((part, i) => {
    const m = part.match(/^\[([^\]]+)\]\(([^)]+)\)$/);
    if (m) return (
      <a key={i} href={m[2]} target="_blank" rel="noopener noreferrer"
        style={{ color:"#b85c35", textDecoration:"underline", textUnderlineOffset:3, fontWeight:500 }}>
        {m[1]}
      </a>
    );
    return part;
...
// id = numéro d'ordre de publication
// Ordre du tableau = ordre d'affichage page Articles (inversé via .reverse())
const ARTICLES = [
  {
    id: 1,
    cat: "Rétrospective",
    ...
    sections: [
      {
        heading: "Continuité des activités : préparer l'inattendu",
        content: "En avril 2025, [une panne géante d'électricité a plongé l'Espagne et le Portugal dans le noir](https://fr.euronews.com/my-europe/2025/06/17/espagne-le-black-out-du-28-avril-a-une-origine-multifactorielle-selon-le-gouvernement) pendant plusieurs heures, paralysant les télécommunications, les transports et de nombreux services essentiels. Cette crise a mis en lumière la fragilité des infrastructures critiques face à des événements en cascade.\n\nFin 2025, [Cloudflare a connu plusieurs interruptions majeures affectant jusqu'à 28 % du trafic mondial](https://blog.cloudflare.com/5-december-2025-outage/). Ces incidents rappellent que la dépendance à des services tiers, même robustes, nécessite une planification proactive de la redondance et des scénarios de basculement.\n\nLa crise climatique et les fortes chaleurs de l'été ont également montré leurs effets sur la continuité : [les canicules remettent en question la capacité des systèmes industriels](https://investir.lesechos.fr/actu-des-valeurs/la-vie-des-actions/les-vagues-de-chaleur-pourraient-couter-05-point-de-pib-a-leurope-en-2025-allianz-trade-2174164) et services publics à fonctionner en dehors des plages de températures prévues.\n\nDans ce contexte, il est primordial de connaître ses activités critiques, d'avoir défini des délais maximums d'interruption acceptables (RTO/RPO), de lister les dépendances clés et de se préparer à leur défaillance."
      },
      {
        heading: "Gestion des tiers et fournisseurs : une stratégie de contournement plus qu'un contrat",
        content: "Les tensions géopolitiques et commerciales continuent de peser sur les chaînes d'approvisionnement mondiales. Les conflits, les hausses de droits de douane et la dépendance à des acteurs uniques — comme [la Chine pour les terres rares](https://www.lemonde.fr/economie/article/2025/10/09/terres-rares-la-chine-renforce-les-controles-sur-l-exportation-des-technologies-liees-a-ces-metaux-strategiques_6645421_3234.html) — créent des vulnérabilités qui peuvent bloquer l'ensemble de la chaîne de distribution.\n\nEn France, début 2025, [une pénurie de médicaments a illustré concrètement cette fragilité](https://www.medtechfrance.fr/vie-de-la-profession/actualites/penurie-medicaments-crise-conjoncturelle-ou-structurelle-etat-lieux-france-janvier-2025/) : la production de principes actifs dépendait jusqu'à 80 % de l'Inde et de la Chine.\n\nPour sécuriser ses activités, il devient essentiel de cartographier les dépendances critiques, de diversifier les sources d'approvisionnement et de développer des stratégies de proximité, de stockage stratégique, voire d'autonomie locale."
      },
      {
        heading: "Technologies : opportunités et menaces",
        content: "La cybersécurité est au cœur de la résilience technologique. Les volumes d'incidents cybercriminels continuent d'augmenter, ciblant notamment [les secteurs critiques](https://www.weforum.org/stories/2024/04/cybercrime-target-sectors-cybersecurity-news/) (santé, énergie, transports). Les rapports [Security Navigator 2025](https://www.orangecyberdefense.com/fr/insights/livres-blancs-et-reportings/security-navigator-2025) et [2026](https://www.orangecyberdefense.com/fr/security-navigator-2026) d'Orange Cyberdéfense montrent une explosion d'événements et de cas d'extorsion numérique. Les attaques sont de plus en plus menées par des « hacktivistes » soutenant des États.\n\nL'intelligence artificielle, sans doute le sujet clé de 2025, joue un rôle ambivalent. Elle constitue à la fois un facteur d'amplification des risques (phishing ciblé, deepfakes, attaques automatisées) et un levier majeur de robustesse (veille informationnelle, détection d'anomalies, simulation de scénarios de crise).\n\nL'enjeu n'est pas l'IA en elle-même, mais sa gouvernance : intégrée dans une stratégie de résilience globale, elle peut transformer une menace potentielle en avantage stratégique."
      },
      {
        heading: "Ressources humaines : anticiper la guerre des talents",
        content: "L'un des défis les plus récents est la « guerre des talents », notamment dans les domaines technologiques avancés. La pénurie de profils spécialisés conduit à des stratégies d'attraction agressives — [Meta a offert 1,5 milliard de dollars sur six ans](https://www.roboto.fr/blog/la-guerre-des-talents-en-ia-pourquoi-un-ingenieur-a-refuse-1-5-milliard-de-meta) pour recruter l'un des plus grands talents en IA.\n\nPour rester compétitives et résilientes, les organisations doivent investir dans la gestion prévisionnelle des emplois et des compétences (GPEC), la formation continue et la fidélisation des talents clés. Cela réduit les risques de rupture opérationnelle liés à un déficit de compétences."
      },
      {
        heading: "Légal et juridique : conformité et responsabilité accrues",
        content: "L'environnement réglementaire a évolué rapidement en 2025, avec trois textes majeurs qui structurent la résilience numérique en Europe :\n\n[DORA (Digital Operational Resilience Act)](https://www.eiopa.europa.eu/digital-operational-resilience-act-dora_en) renforce la résilience opérationnelle dans le secteur financier. La [directive NIS2](https://monespacenis2.cyber.gouv.fr/directive/) élargit les obligations de gestion des risques cyber dans l'UE. Le [Cyber Resilience Act (CRA)](https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act) oblige les fabricants à intégrer des exigences de sécurité dans les produits numériques.\n\nEn France, la réforme 2025 de la protection des données introduit de nouvelles obligations pour les grandes organisations. Les décisions judiciaires récentes confirment par ailleurs la responsabilité personnelle des dirigeants en cas de négligence dans la gestion des risques.\n\nPour rester conformes, les organisations doivent adopter une culture de résilience globale, avec une gouvernance claire et une exigence de sécurité dès la conception."
      },
      {
        heading: "Conclusion : vers une résilience globale",
        content: "Les crises de 2025 confirment que la résilience ne se limite pas à un plan de reprise d'activité ou à la cybersécurité. Elle nécessite une approche globale, intégrant les dimensions humaines, technologiques, environnementales, juridiques et géopolitiques.\n\nPour 2026, les organisations les plus robustes seront celles qui adoptent une vision globale dépassant les silos, construisent leur résilience dès la conception, anticipent grâce à des exercices réguliers, collaborent avec des partenaires publics et privés, et restent agiles face aux chocs externes."
      },
    ]
  },
  {
      ...
      <section style={{ padding:"72px 40px" }}>
        <div style={{ maxWidth:820, margin:"0 auto" }}>
          <div style={{ marginBottom:52, paddingBottom:48, borderBottom:"1px solid #ecddd0" }}>
            {article.intro.split("\n\n").map((p,i) => (
              <p key={i} style={{ fontSize:19, color:"#2a1810", lineHeight:1.9, marginBottom:"1.4em", fontWeight:300 }}>{renderContent(p)}</p>
            ))}
          </div>
          {article.sections.map((s,i) => (
            <div key={i} style={{ marginBottom:48, paddingBottom:48, borderBottom:i<article.sections.length-1?"1px solid #ecddd0":"none" }}>
              ...
              <div className="art-body">
                {s.content.split("\n\n").map((p,j) => <p key={j}>{renderContent(p)}</p>)}
              </div>
            </div>
          ))}
